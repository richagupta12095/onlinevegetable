...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() { 
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'delivery_boy'  => $this->model_user_user->getUser($result['deliverybid'])['username'],
		...
		$data['sort_deliverybid'] = $this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.deliverybid' . $url, true);
	...
	public function acceptOrder() {
		...
		if (!isset($this->request->get['order_id'])) {
			...
			$comment = 'Order has been Marked as out of Delivery'; //Shipped			
			if ($order_id) {
				$this->model_sale_order->addOrderHistory($order_id,$order_status_id, $comment, false, true);
				$json['success'] = 'Order Marked Shipped Successfully';
			} else {
	...
	public function deliveredOrder() {
		...
		if (!isset($this->request->get['order_id'])) {
			...
			$order_status_id = 5; //Shipped
			$comment = 'Order has been Delivered'; //Shipped			
			if ($order_id) {
				$this->model_sale_order->addOrderHistory($order_id,$order_status_id, $comment, false, true);
				$json['success'] = 'Order Marked Shipped Successfully';
			} else {
