...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['tnc_img'])) {

			$data['tnc_img'] = $this->request->post['tnc_img'];

		} elseif (!empty($product_info)) {

			$data['tnc_img'] = $product_info['tnc_image'];
		...
		if (isset($this->request->post['tnc'])) {

			$data['tnc'] = $this->request->post['tnc'];

		} elseif (!empty($product_info)) {

			$data['tnc'] = $product_info['tnc'];
		...
		$data['weight_values'] = $this->model_catalog_product->getWeightValues();
		
		$data['product_weight_values'] = array();

		if (isset($this->request->post['product_weight_values'])) {

			$data['product_weight_values'] = $this->request->post['product_weight_values'];

		} elseif (isset($this->request->get['product_id'])) {

			$data['product_weight_values'] = $this->model_catalog_product->getProductWeightValues($this->request->get['product_id']);
