<?php
// HTTP
define('HTTP_SERVER', 'http://13.233.98.88/admin/');
define('HTTP_CATALOG', 'http://13.233.98.88/');

// HTTPS
define('HTTPS_SERVER', 'http://13.233.98.88/admin/');
define('HTTPS_CATALOG', 'http://13.233.98.88/');
