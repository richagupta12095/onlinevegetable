...
class ControllerCommonHeader extends Controller {
	...
	public function index() {
		...
		$data['telephone'] = $this->config->get('config_telephone');
			...
			/*CiBlog start*/
			$data['ciblog_store_status'] = (int)$this->config->get('ciblog_store_status');
			if((int)$this->config->get('ciblog_store_status')) {
				$this->load->language('extension/ciblog/ciblog_menu');
				$data['text_ciblog'] = $this->language->get('text_ciblog');
				$data['ciblog'] = $this->url->link('extension/ciblog/ciblog','', true);
			}
			/*CiBlog end*/
