...
class __TwigTemplate_49dad4fd3ececc8891249909b2f54ecd337ddfd83bffafdf341bc536a0ad9c9e extends Twig_Template
{
      ...
      <button class=\"btn btn-link dropdown-toggle\" data-toggle=\"dropdown\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["currency"]) {
                ...
                if (($this->getAttribute($context["currency"], "symbol_left", array()) && ($this->getAttribute($context["currency"], "code", array()) == (isset($context["code"]) ? $context["code"] : null)))) {
                    echo " <strong class=\"hidden-md hidden-sm hidden-lg\">";
...
/*       {% if currency.symbol_left and currency.code == code %} <strong class="hidden-md hidden-sm hidden-lg">{{ currency.symbol_left }}</strong> {% elseif currency.symbol_right and currency.code == code %} <strong>{{ currency.symbol_right }}</strong> {% endif %}*/
/*       {% endfor %} <span class="hidden-xs">{{ text_currency }}</span>&nbsp;<i class="fa fa-angle-down"></i></button>*/
/*       <ul class="dropdown-menu dropdown-menu-right">*/
