...
class ModelAccountAddress extends Model {
	...
	public function editAddressOnCheckout($address_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "address SET firstname = '" . $this->db->escape($data['edit_firstname']) . "', lastname = '" . $this->db->escape($data['edit_lastname']) . "', company = '" . $this->db->escape($data['edit_company']) . "', address_1 = '" . $this->db->escape($data['edit_address_1']) . "', address_2 = '" . $this->db->escape($data['edit_address_2']) . "', postcode = '" . $this->db->escape($data['edit_postcode']) . "', city = '" . $this->db->escape($data['edit_city_dropdown']) . "', zone_id = '" . (int)$data['edit_zone_id'] . "', country_id = '" . (int)$data['edit_country_id'] . "', custom_field = '" . $this->db->escape(isset($data['custom_field']['address']) ? json_encode($data['custom_field']['address']) : '') . "' WHERE address_id  = '" . (int)$address_id . "' AND customer_id = '" . (int)$this->customer->getId() . "'");
