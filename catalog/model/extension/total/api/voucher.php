<?php
class ModelExtensionTotalApiVoucher extends Model {
	...
	public function getTotal($total, $data) {
		...
		if (isset($data['voucher'])) {
			...
			$voucher_info = $this->getVoucher($data['voucher']);
			...
			if ($voucher_info) {
				...
				if ($amount > 0) {
					$total['totals'][] = array(
						'code' => 'voucher',
						'title' => sprintf($this->language->get('voucher')->get('text_voucher'), $data['voucher']),
						'value' => -$amount,
