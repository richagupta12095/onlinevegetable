...
class ControllerExtensionOnepagecheckoutCheckout extends Controller {
	...
	public function index(){
		...
		$data['guest_status'] = ($this->config->get('config_checkout_guest') && !$this->config->get('config_customer_price') && !$this->cart->hasDownload() && !empty($onepagecheckout_manage['personaldetails']['guest_status'])) ? 1 : '';
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			$data['entry_telephone'] = (!empty($onepagecheckout_manage['register']['telephone']['label'][$this->config->get('config_language_id')]) ? $onepagecheckout_manage['register']['telephone']['label'][$this->config->get('config_language_id')] : 'Telephone');
			
			$data['telephone_status'] = (isset($onepagecheckout_manage['personaldetails']['fields']['telephone']['show']) ? $onepagecheckout_manage['personaldetails']['fields']['telephone']['show'] : 0);
