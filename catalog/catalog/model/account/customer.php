...
class ModelAccountCustomer extends Model {
	...
	public function getCustomerByPhone($phone) {
		$query = $this->db->query("SELECT customer_id,customer_group_id,firstname,lastname,email,telephone FROM " . DB_PREFIX . "customer WHERE telephone = '" . $this->db->escape($phone) . "'");
	...
	public function getTotalCustomersByMobile($mobile) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer WHERE telephone = '" . $this->db->escape($mobile) . "'");
