	...
	public function quote() {
		...
		if (!$json) {
			...
			if ($this->customer->isLogged()){
	            ...
	            if(!empty($quote_data)  && isset($quote_data['xshippingpro']) && isset($plan_details) && !empty($plan_details)){ 
	                unset($quote_data['xshippingpro']['quote']['xshippingpro1']);
	            }else{
					unset($quote_data['xshippingpro']['quote']['xshippingpro2']);
				}
        	}else{
	            if(!empty($quote_data)  && isset($quote_data['xshippingpro'])){ 
	                unset($quote_data['xshippingpro']['quote']['xshippingpro2']);
	            }
        	}
