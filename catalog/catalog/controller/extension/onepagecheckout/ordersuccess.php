...
class ControllerExtensionOnepagecheckoutOrderSuccess extends Controller {
	...
	public function printinvoice(){
		...
		if($order_info){
				...
				$data['text_order_detail'] = ($this->config->get('order_success_page_order_details_heading'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_order_details_heading'.$this->config->get('config_language_id')) : $this->language->get('text_order_detail'));
				$data['text_instruction'] = ($this->config->get('order_success_page_order_comment_heading'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_order_comment_heading'.$this->config->get('config_language_id')) : $this->language->get('text_instruction'));
				...
				$data['text_product'] = ($this->config->get('order_success_page_product_title'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_product_title'.$this->config->get('config_language_id')) : $this->language->get('text_product'));
				
				$data['text_model'] = ($this->config->get('order_success_page_model_title'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_model_title'.$this->config->get('config_language_id')) : $this->language->get('text_model'));
				...
				$data['text_quantity'] = ($this->config->get('order_success_page_qty_title'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_qty_title'.$this->config->get('config_language_id')) : $this->language->get('text_quantity'));
				
				$data['text_price'] = ($this->config->get('order_success_page_unit_title'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_unit_title'.$this->config->get('config_language_id')) : $this->language->get('text_price'));
				
				$data['text_total'] = ($this->config->get('order_success_page_total_title'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_total_title'.$this->config->get('config_language_id')) : $this->language->get('text_total'));
