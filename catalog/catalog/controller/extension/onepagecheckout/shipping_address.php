<?php
/********************************************
Extension Name : OnePage Checkout
...
class ControllerExtensionOnepagecheckoutShippingAddress extends Controller {
	...
	public function index(){
		...
		foreach($fields as $key => $feild){
			...
			if($status){
				$data['feilds'][$key]=array(
					...
					'required'		=> $required,
					'key'					=> $key,
					'label'				=> ($onepagecheckout_manage['delivery_detail'][$key]['label'][$this->config->get('config_language_id')] ? $onepagecheckout_manage['delivery_detail'][$key]['label'][$this->config->get('config_language_id')] : $this->language->get('entry_'.$key)),
		...
		$data['entry_heading'] = ($onepagecheckout_manage['delivery_detail']['heading_title'][$this->config->get('config_language_id')] ? $onepagecheckout_manage['delivery_detail']['heading_title'][$this->config->get('config_language_id')] : 'Shipping Address');
