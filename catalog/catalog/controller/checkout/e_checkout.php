...
class ControllerCheckoutecheckout extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('text_e_wallet_payment'),
			'href' => $this->url->link('checkout/e_checkout', '', true)
		);

		$data['heading_title'] = $this->language->get('text_e_wallet_payment');		
		...
		$this->response->setOutput($this->load->view('checkout/e_checkout', $data));
	}
